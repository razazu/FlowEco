        ...
        return `
            <div class="exp-item" onclick="FlowEcoExp.editExpense('${exp.id}')">
                ...
                <div class="exp-item-meta">
                    ...
                    ${exp.is_recurring ? '<span class="exp-item-tag recurring">🔄 חוזר</span>' : ''}
                </div>
            </div>
        `;
    }).join('');
            ...
            <div class="exp-item" onclick="FlowEcoExp.editLoan('${loan.id}')" style="border-color: rgba(245, 158, 11, 0.4);">
                <div class="exp-item-main">
                    ...
                    <div class="exp-item-info">
                        ...
                        <div class="exp-item-desc">${loan.lender || 'הלוואה'} | נותרו ${loan.remaining_months} חודשים</div>
                    </div>
                ...
                <div class="exp-item-meta">
                    ...
                    <span class="exp-item-tag">📅 יתרה: ₪${(loan.remaining_amount || 0).toLocaleString('he-IL')}</span>
                </div>
            </div>
        `;
    });

...
function floweco_dashboard_v2_shortcode() {
    ...
    <div class="dash-container" dir="rtl">
        ...
        <section class="dash-summary">
            <a href="/incomes" class="dash-summary-card income clickable">
            ...
            <a href="/expenses" class="dash-summary-card expenses clickable">
                <div class="dash-card-icon">💸</div>
                <div class="dash-card-info">
            ...
            <a href="/budget" class="dash-summary-card budget clickable">
                <div class="dash-card-icon">🎯</div>
                <div class="dash-card-info">
                    <span class="dash-card-label">תקציב החודש</span>
                    <span class="dash-card-value" id="dashBudgetUsed">₪0</span>
                    <div class="dash-budget-bar">
                        <div class="dash-budget-bar-fill" id="dashBudgetBarFill"></div>
                    </div>
                </div>
            </a>
            <a href="/reports" class="dash-summary-card balance clickable">
                <div class="dash-card-icon">📊</div>
                <div class="dash-card-info">
            ...
            <a href="/reports" class="dash-summary-card savings clickable">
                <div class="dash-card-icon">📈</div>
                <div class="dash-card-info">

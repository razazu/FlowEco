    ...
    <div class="exp-modal">
        ...
        <form id="formAddLoan" onsubmit="FlowEcoExp.saveLoan(event)">
            <div class="exp-form-grid">
                ...
                <!-- כפתור פתיחת פרטים נוספים -->
                <div class="exp-form-group full-width">
                    <button type="button" class="exp-btn-expand" onclick="FlowEcoExp.toggleLoanDetails(\'add\')">
                        <span id="addLoanExpandIcon">▼</span>
                        <span>פרטים נוספים (אופציונלי)</span>
                    </button>
                </div>
                
                <!-- פרטים נוספים - מוסתרים כברירת מחדל -->
                <div class="exp-loan-details-section hidden" id="addLoanDetailsSection">
                    <div class="exp-form-group">
                    ...
                    <div class="exp-form-group">
                        ...
                        <div class="exp-input-wrapper">
                            <span class="exp-input-prefix">₪</span>
                            <input type="number" step="0.01" class="exp-form-input" id="addLoanAmount">
                        </div>
                    </div>
                    <div class="exp-form-group">
                        <label class="exp-form-label">📆 תקופה (חודשים)</label>
                        <input type="number" min="1" max="360" class="exp-form-input" id="addLoanMonths">
                    </div>
                    <div class="exp-form-group">
                    ...
                    <div class="exp-form-group">
                        ...
                        <input type="date" class="exp-form-input" id="addLoanStart">
                    </div>
                    <div class="exp-form-group">
    ...
    <div class="exp-modal">
        ...
        <form id="formEditExpense" onsubmit="FlowEcoExp.updateExpense(event)">
            ...
            <div class="exp-form-grid">
                ...
                <div class="exp-form-group full-width">
                    <label class="exp-checkbox-label">
                        <input type="checkbox" id="editExpRecurring" onchange="FlowEcoExp.toggleRecurring(\'edit\')">
                        <span class="exp-checkbox-text">🔄 הוצאה חוזרת</span>
                    </label>
                </div>
                <div class="exp-form-group hidden" id="editExpRecurringGroup">
                    <label class="exp-form-label">תדירות</label>
                    <select class="exp-form-select" id="editExpRecurringType">
                        <option value="monthly">חודשי</option>
                        <option value="weekly">שבועי</option>
                        <option value="yearly">שנתי</option>
                    </select>
    ...
    <div class="exp-modal">
        ...
        <form id="formEditLoan" onsubmit="FlowEcoExp.updateLoan(event)">
            ...
            <div class="exp-form-grid">
                ...
                <!-- כפתור פתיחת פרטים נוספים -->
                <div class="exp-form-group full-width">
                    <button type="button" class="exp-btn-expand" onclick="FlowEcoExp.toggleLoanDetails(\'edit\')">
                        <span id="editLoanExpandIcon">▼</span>
                        <span>פרטים נוספים (אופציונלי)</span>
                    </button>
                </div>
                
                <!-- פרטים נוספים -->
                <div class="exp-loan-details-section hidden" id="editLoanDetailsSection">
                    <div class="exp-form-group">
                        <label class="exp-form-label">🏛️ גוף מלווה</label>
                    ...
                    <div class="exp-form-group">
                        ...
                        <div class="exp-input-wrapper">
                            <span class="exp-input-prefix">₪</span>
                            <input type="number" step="0.01" class="exp-form-input" id="editLoanRemaining">
                        </div>
                    </div>
                    <div class="exp-form-group">
                        <label class="exp-form-label">📆 חודשים שנותרו</label>
                        <input type="number" min="0" class="exp-form-input" id="editLoanMonthsLeft">
                    </div>
                    <div class="exp-form-group">
                        <label class="exp-form-label">📊 סטטוס</label>
